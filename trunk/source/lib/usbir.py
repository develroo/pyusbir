...
class shutterglass:
  ...
  def set_rate(self,rate=120):
    ...
    self.cmdTimings = [0x01,0x00,0x18,0x00,0x41,0xEC,0xFE,0xFF,0x66,0xB8,0xFF,0xFF,0x30,0xF8,0xFF,0xFF,0x24,0x28,0x30,0x22,0x05,0x08,0x0A,0x04,0x82,0xD8,0xFD,0xFF]
