...
class shutterglass:
  ...
  def set_rate(self,rate=120):
    ...
    self.activeTime  = 2080 * self.const
    w = int(self.NVSTUSB__COUNT(4568.50*self.const,(self.NVSTUSB_CLOCK/4)))
    x = int(self.NVSTUSB__COUNT(4774.25*self.const,(self.NVSTUSB_CLOCK/12)))
